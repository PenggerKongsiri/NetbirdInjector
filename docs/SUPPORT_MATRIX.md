...
| Public `curl` entry installer | Designed; ShellCheck/archive-policy locally tested; experimental | Public GitHub API/archive download and complete disposable-VM run required |
